...
<hr>
<h5 style="text-align: center;">REPORTE DE INFRACCIONES E INCUMPLIMIENTOS</h5>
...
@else
    <div>
        <p>No se encontraron actas de Infraccionoes</p>
    </div>
@endif
...
@else
    <div>
        <p>No se encontraron actas de Incumplimientos</p>
    </div>
@endif
@php
